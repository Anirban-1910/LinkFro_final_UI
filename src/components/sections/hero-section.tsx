            ...
            <div className="relative z-[150] flex h-full flex-row items-center xl:w-[65%] pb-20 md:pb-24 lg:pb-28">
              <div className="m-auto flex flex-1 flex-col gap-y-6 px-8 text-center md:m-0 md:max-w-full md:px-12 md:text-left lg:px-14 xl:gap-y-3 xl:pl-[100px]">
                ...
                <div className="flex flex-col gap-y-4 sm:mx-auto sm:flex-row sm:gap-x-4 md:mx-0 xl:mt-0.5">
                  <a href="/dashboard/publisher" className="relative flex items-center justify-center rounded-lg px-6 font-normal whitespace-nowrap min-h-[39px] text-small-button-text font-body text-white bg-gradient-to-r from-cta-primary-start to-cta-primary-end hover:brightness-110 transition-all duration-300 shadow-[0_0_20px_0_var(--color-glow-effect)]">
                    List Your Website
                  </a>
                  <a href="/dashboard/consumer" className="relative flex items-center justify-center rounded-lg px-6 font-normal whitespace-nowrap min-h-[39px] text-small-button-text font-body text-white border border-cta-secondary-border bg-transparent hover:bg-white/10 transition-colors duration-300">
                    Browse Marketplace
                  </a>
                </div>
              </div>
