        ...
        <div className="rounded-lg border border-[rgba(193,193,193,0.15)] bg-[rgba(0,0,0,0.92)] backdrop-blur-[30px]">
          <div className="flex min-h-[68px] items-center justify-between px-3 lg:px-3">
            ...
            <div className="flex items-center gap-2">
              <SignedOut>
                <a href="/dashboard/publisher" className="hidden whitespace-nowrap px-5 py-3 text-sm leading-[130%] tracking-[.3px] text-text-secondary sm:block xl:text-md hover:text-white transition-colors">
                  Publish
                </a>
                <SignInButton mode="modal">
                  <button className="hidden whitespace-nowrap px-5 py-3 text-sm leading-[130%] tracking-[.3px] text-text-secondary sm:block xl:text-md hover:text-white transition-colors">
                    Sign in
                  </button>
                </SignInButton>
                <SignInButton mode="modal">
                  <button className="text-small-button-text xl:text-sm font-body tracking-[.3px] ml-1 px-[14px] min-h-[39px] inline-flex items-center justify-center rounded-lg text-white bg-gradient-to-r from-cta-primary-start to-cta-primary-end hover:brightness-110 transition-all">
                    Request Access
                  </button>
                </SignInButton>
              </SignedOut>
              ...
              <SignedIn>
                ...
                <a href="/dashboard/publisher" className="text-small-button-text xl:text-sm font-body tracking-[.3px] ml-1 px-[14px] min-h-[39px] inline-flex items-center justify-center rounded-lg text-white bg-gradient-to-r from-cta-primary-start to-cta-primary-end hover:brightness-110 transition-all">
                  Publisher Dashboard
                </a>
                <UserButton 
              ...
              <div className="p-5 overflow-y-auto h-[calc(100vh-69px)]">
                <ul className="flex flex-col gap-y-2">
                  ...
                  <li className="pt-4 border-t border-border">
                    <SignedOut>
                      <SignInButton mode="modal">
                        <button className="block w-full px-4 py-3 text-lg text-text-primary hover:bg-white/5 rounded-md text-left">
                          Sign in
                        </button>
                      </SignInButton>
                    </SignedOut>
                    <SignedIn>
                      <div className="block w-full px-4 py-3 text-lg text-text-primary">
                        <UserButton 
                          userProfileMode="modal"
                          userProfileProps={{
                            additionalOAuthScopes: {
